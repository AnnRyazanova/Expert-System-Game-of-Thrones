...
факты_советники(Индекс) :- получение_фактов_советники(Список, _), печать_советников(Список, Индекс).
...
все_факты :- получение_фактов_персонажи(Список, Длина), печать(Список, 1), 
			 ...
			 получение_фактов_советники(Список4, Длина4), L3 is (L2 + Длина3), write('Являются советниками : \n'), печать(Список4, L3).
